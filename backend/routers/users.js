...
router.get('/login', async (req, res) => {
    ...
    else { return res.status(400).json({ success: false, message: 'Invalid password' }); }
...
router.put('/:id',async (req,res) => {
    ...
    if(!user) {
        return res.status(400).json({ success: false, message: 'the user could not be updated' });
    }
...
router.post('/register', async (req, res) => {
    ...
    if(!user) {
        return res.status(400).json({ success: false, message: 'the user could not be registered' });
    }
